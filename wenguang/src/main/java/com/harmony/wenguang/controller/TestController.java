...
public class TestController {
	...
	public String createTable(){
    	try {
    		...
    		executeSql("create table wg_documents(id int primary key AUTO_INCREMENT,file_type varchar(20),doc_name varchar(200),doc_path varchar(200),doc_content blob, status varchar(10))");
