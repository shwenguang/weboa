...
<table id="input_table" width="600" class="table_xxzx" style="border:1px solid #e70000;" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td class="table_fff" colspan="8">
    <input name="info_of_gov" align="left" class="text1" type="text" size="55" value="上海市文化广播影视管理局(上海市文物局)">
    </td>
  </tr>
  <tr>
	...
	<textarea name="info_descriptor" class="text1" rows="4" cols="40" style="width: 80%"></textarea>
	</td>
  </tr>
  <tr>
  ...
  <tr>
  	<td align="left" class="table_fff" colspan="4">
  		<textarea name="info_usage_remark" class="text1" rows="4" cols="40" style="width: 80%"></textarea>
  	</td>
  </tr>
  <tr>
